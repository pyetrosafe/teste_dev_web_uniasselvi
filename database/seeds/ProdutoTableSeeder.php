...
class ProdutoTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('tbl_produto')->insert([
            ...
            'valor' => 1099,
            'ativo' => true,
            'imagem' => 'public/produtos/processador-amd-ryzen-5-3600-36ghz-42ghz-turbo-6-core-12-thread-cooler-wraith-stealth-am4_76288.jpg',
            'created_at' => 'now()',
        ]);
        ...
        DB::table('tbl_produto')->insert([
            ...
            'valor' => 969,
            'ativo' => true,
            'imagem' => 'public/produtos/placa-mae-asrock-x470-master-sliac-chipset-x470-amd-am4-atx-ddr4_76613.jpg',
            'created_at' => 'now()',
        ]);
        ...
        DB::table('tbl_produto')->insert([
            ...
            'valor' => 279,
            'ativo' => true,
            'imagem' => 'public/produtos/memoria-ddr4-crucial-ballistix-sport-lt-red-8gb-3000mhz-bls8g4d30aesek_71375.jpg',
            'created_at' => 'now()',
        ]);
        ...
        DB::table('tbl_produto')->insert([
            ...
            'valor' => 329,
            'ativo' => true,
            'imagem' => 'public/produtos/ssd-crucial-mx500-250gb-m2-2280-leitura-560mbs-gravacao-510mbs-ct250mx500ssd4_71400.jpg',
            'created_at' => 'now()',
        ]);
        ...
        DB::table('tbl_produto')->insert([
            ...
            'valor' => 179.9,
            'ativo' => true,
            'imagem' => 'public/produtos/ssd-kingston-a400-240gb-sa400s37240g-sata-iii-leitura-500mbs-gravacao-350mbs_37617.jpg',
            'created_at' => 'now()',
        ]);
        ...
        DB::table('tbl_produto')->insert([
            ...
            'valor' => 239,
            'ativo' => true,
            'imagem' => 'public/produtos/hd-seagate-barracuda-st1000dm010-1tb-7200rpm-64mb-sata-iii_36318.jpg',
            'created_at' => 'now()',
        ]);
        ...
        DB::table('tbl_produto')->insert([
            ...
            'valor' => 339.9,
            'ativo' => true,
            'imagem' => 'public/produtos/hd-western-digital-caviar-blue-wd20ezrz-2tb-5200rpm-64mb-sata-iii_28320.jpg',
            'created_at' => 'now()',
        ]);
        ...
        DB::table('tbl_produto')->insert([
            ...
            'valor' => 299,
            'ativo' => true,
            'imagem' => 'public/produtos/fonte-corsair-vs650-650w-cp-9020172-ww-80-plus-pfc-ativo_55039.jpg',
            'created_at' => 'now()',
        ]);
        ...
        DB::table('tbl_produto')->insert([
            ...
            'valor' => 999,
            'ativo' => true,
            'imagem' => 'public/produtos/placa-de-video-asus-radeon-rx-580-dual-oc-dual-rx580-o8g-8gb-gddr5_65740.jpg',
            'created_at' => 'now()',
        ]);
        ...
        DB::table('tbl_produto')->insert([
            ...
            'valor' => 1329,
            'ativo' => true,
            'imagem' => 'public/produtos/placa-de-video-galax-geforce-gtx-1660-ti-oc-6gb-60irl7dsy91c-gddr6-pci-exp_68119.png',
            'created_at' => 'now()',
        ]);
        ...
        DB::table('tbl_produto')->insert([
            ...
            'valor' => 195,
            'ativo' => true,
            'imagem' => 'public/produtos/gabinete-aerocool-rift-rgb-lateral-em-acrilico-mid-tower-preto_67280.png',
            'created_at' => 'now()',
        ]);
    }
}
